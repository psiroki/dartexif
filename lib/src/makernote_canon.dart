...
class makernote_canon extends tags_base {
  ...
  static Map<int, MakerTag> _build_tags() {
    return {
      ...
      0x0015: _withMap('SerialNumberFormat',
          {0x90000000: 'Format 1', 0xA0000000: 'Format 2'}),
      0x001a: _withMap(
          'SuperMacro', {0: 'Off', 1: 'On const ()', 2: 'On const ()'}),
  ...
  // 0x0001
  static Map<int, MakerTag> CAMERA_SETTINGS = _build_camera_settings();

  static _build_camera_settings() {
    return {
  ...
  // 0x0002
  static Map<int, MakerTag> FOCAL_LENGTH = {
  ...
  // 0x0004
  static Map<int, MakerTag> SHOT_INFO = {
  ...
  // 0x0026
  static Map<int, MakerTag> AF_INFO_2 = {
  ...
  // 0x0093
  static Map<int, MakerTag> FILE_INFO = {
    1: _make('FileNumber'),
  ...
  static int _add_one(int value) {
    return value + 1;
  }

  static int _subtract_one(int value) {
    return value - 1;
  }
  ...
  // specified offset.
  static const CAMERA_INFO_TAG_NAME = 'MakerNote Tag 0x000D';

  // [name, byte_length, func]
  static Map<int, List> _CAMERA_INFO_5D = {
    23: ['CameraTemperature', 1, _convert_temp],
    204: ['DirectoryIndex', 4, _subtract_one],
    208: ['FileIndex', 2, _add_one],
  };

  static Map<int, List> _CAMERA_INFO_5DMKII = {
    25: ['CameraTemperature', 1, _convert_temp],
    443: ['FileIndex', 4, _add_one],
    455: ['DirectoryIndex', 4, _subtract_one],
  };

  static Map<int, List> _CAMERA_INFO_5DMKIII = {
    27: ['CameraTemperature', 1, _convert_temp],
    652: ['FileIndex', 4, _add_one],
    656: ['FileIndex2', 4, _add_one],
    664: ['DirectoryIndex', 4, _subtract_one],
    668: ['DirectoryIndex2', 4, _subtract_one],
  };

  static Map<int, List> _CAMERA_INFO_600D = {
    25: ['CameraTemperature', 1, _convert_temp],
    475: ['FileIndex', 4, _add_one],
    487: ['DirectoryIndex', 4, _subtract_one],
  };

  // A map of regular expressions on 'Image Model' to the CameraInfo spec
  static Map<String, Map<int, List>> CAMERA_INFO_MODEL_MAP = {
    r'EOS 5D$': _CAMERA_INFO_5D,
    r'EOS 5D Mark II$': _CAMERA_INFO_5DMKII,
    r'EOS 5D Mark III$': _CAMERA_INFO_5DMKIII,
    r'\b(600D|REBEL T3i|Kiss X5)\b': _CAMERA_INFO_600D,
  };
}
